...
<html lang="en">
  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-blocks-cover" style="background-image: url(images/bg1.png);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2">Mecato Vallunos</h1>
            <div class="intro-text text-center text-md-left">
              <p class="mb-4">Disfruta todas las variedades de mecato valluno que ofrecemos para ti. </p>
              <p>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="text">
              ...
              <p>Envío gratis en cualquier parte del país Colombiano.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text">
              ...
              <p>Nos comprometemos con la devolución de del envio.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="text">
              ...
              <p>Te damos la mejor atencion al cliente las 24 horas.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="item">
                <div class="block-4 text-center">
                  ...
                  <div class="block-4-text p-4">
                    ...
                    <p class="mb-0">Encuentra el regalo perfecta</p>
