...
if($arregloUsuario['nivel']!='admin' && $arregloUsuario['nivel']!='asesor' && $arregloUsuario['nivel']!='gerente') {
  header("Location: ../admin/");
}



    $resultado = $conexion ->query("select * from contacto where id order by id DESC")or die($conexion->error);
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="offset-xl-3 col-xl-6">
            <h1 class="m-0"style="text-align: center">Gestion de Buzones</h1>
          </div><!-- /.col -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="modalEliminar">Eliminar Buzon</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      ¿Desea Eliminar el Buzon?
   </div>
