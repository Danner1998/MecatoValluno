          ...
          <section class="col-lg-7 connectedSortable">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      ...
                      <span class="direct-chat-timestamp float-right">23 de enero a las 14:00 </span>
                    </div>
                    <!-- /.direct-chat-infos -->
                  ...
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      ...
                      <span class="direct-chat-timestamp float-left">23 de enero a las 14:05 </span>
                    </div>
                    <!-- /.direct-chat-infos -->
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left">Alexander Pierce</span>
                      <span class="direct-chat-timestamp float-right">23 de enero a las 17:37 </span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="./dashboard/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                    ¡Trabajando con AdminLTE en una gran aplicación nueva! ¿Quieres unirte? 
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                  ...
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-right">Sarah Bullock</span>
                      <span class="direct-chat-timestamp float-left">23 de enero a las 18:10</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="./dashboard/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          ...
                          <span class="contacts-list-msg">¿Cómo has estado? Yo estaba... </span>
                        </div>
                        <!-- /.contacts-list-info -->
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          ...
                          <span class="contacts-list-msg">Te llamaré de nuevo al ... </span>
                        </div>
                        <!-- /.contacts-list-info -->
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          ...
                          <span class="contacts-list-msg">Donde esta tu nuevo ...</span>
                        </div>
                        <!-- /.contacts-list-info -->
                      </a>
                    </li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  ...
                  <li>
                    ...
                    <span class="text">Haz que el tema sea receptivo </span>
                  ...
                  <li>
                    ...
                    <span class="text">Deja que el tema brille como una estrella </span>
                    <small class="badge badge-success"><i class="far fa-clock"></i> 3 día</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
              ...
              <div class="card-footer clearfix">
                <button type="button" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Agregar elemento</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a href="#" class="dropdown-item">Eventos claros </a>
